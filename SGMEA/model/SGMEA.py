...
class SGMEA(nn.Module):
    ...
    def forward(self, batch):
        ...
        in_loss = self.inner_view_loss(gph_emb, rel_emb, att_emb, img_emb, name_emb, char_emb,  gat_rel_emb, gat_att_emb, gat_img_emb, gat_name_emb, gat_char_emb,batch)
        out_loss = self.inner_view_loss(gph_emb_hid, rel_emb_hid, att_emb_hid, img_emb_hid, name_emb_hid, gat_rel_emb_hid, gat_att_emb_hid, gat_img_emb_hid, gat_name_emb_hid, gat_char_emb_hid, char_emb_hid, batch)
